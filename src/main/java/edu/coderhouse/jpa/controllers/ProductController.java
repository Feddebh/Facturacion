...
public class ProductController {
  ...
  public ResponseEntity<ProductDTO> addProduct (@Valid @RequestBody ProductDTO candidateProductDTO) throws BillingException {
    ...
    return ResponseEntity.status(HttpStatus.CREATED)
            .body(addedProductDTO);
  } //OK
  @PutMapping(value = "/{productId}", consumes = "application/json", produces = "application/json")
  public ResponseEntity<ProductDTO> updateProduct(@PathVariable Long productId, @Valid @RequestBody ProductDTO
          updatedproductDTO) throws BillingException {
  ...
  public ResponseEntity<ProductDTO> getProductById (@NotNull @PathVariable Long productId) throws BillingException {
